...
// TODO 1. Função que retorna outra função como parâmetro
...
// displayWelcomeToFrontEndCourse('Henrique');
// displayWelcomeToBackEndCourse('João');

// TODO 2. Função que recebe outra função como parâmetro
...
// funcaoOperacao: será a função que vai realizar a operação entre os dois números, ou seja, ela precisa ser uma função que 
// receba dois números
