...
// const todosPositivos = numeros.every((elemento) => elemento > 30); // retorna false, pois nem todos os elementos são maiores que 30

// console.log(todosPositivos);

// const todosMaioresIdade = pessoas.every((pessoa) => pessoa.idade >= 18);
// const todosMaioresIdade = pessoas.every((pessoa) => pessoa.idade >= 18 && pessoa.altura >= 1.7);
